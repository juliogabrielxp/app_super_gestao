...
@section('conteudo')
  <div class="topo">
      ...
      <div class="menu">
          <ul>
              <li><a href="{{ route('site.index') }}">Principal</ali>
              <li><a href="{{ route('site.sobre-nos') }}">Sobre Nós</li>
              <li><a href="{{ route('site.contato') }}">Contato</ali>
          </ul>
      </div>
  </div>
  ...
  <div class="conteudo-destaque">
      ...
      <div class="esquerda">
          <div class="informacoes">
              ...
              <p>Software para gestão empresarial ideal para sempresa.<p>
              <div class="chamada">
      ...
      <div class="direita">
          <div class="contato">
              <h1>Contato</h1>
              <p>Caso tenha qualquer dúvida por favor entre contato com nossa equipe pelo formulário abaixo.<p>
              <form>
